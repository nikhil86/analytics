<div id="error-day-views-container" class="graph-container">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form">
                    ...
                    <div class="form-group">
                        <label for="browser-start-date">End Date:</label>
                        <input type="date" class="form-control end-date" id="browser-end-date" value="<%= endDate %>">
                    </div>
                </form>
            </div>
